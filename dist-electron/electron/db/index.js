...
function initDB() {
    ...
    cot_1.COTRepository.init(userDataPath);
            ...
            db.transaction(() => {
                for (const t of trades) {
                    ...
                    if (pv > 0) {
                        ...
                        let derivedSL = 0;
                        if (t.direction === 'Long')
                            derivedSL = t.entry_price - distance;
                        else
                            derivedSL = t.entry_price + distance; // Short
    ...
    try {
        ...
        if (!hasHeatPercent) {
            ...
            const updateStmt = db.prepare('UPDATE trades SET heat_percent = ?, mfe_r = ?, mae_r = ?, profit_capture_percent = ? WHERE id = ?');
            let backfilled = 0;
            db.transaction(() => {
                var _a, _b, _c, _d;
                for (const t of allTrades) {
                    ...
                    updateStmt.run((_a = metrics.heatPercent) !== null && _a !== void 0 ? _a : null, (_b = metrics.mfeR) !== null && _b !== void 0 ? _b : null, (_c = metrics.maeR) !== null && _c !== void 0 ? _c : null, (_d = metrics.profitCapturePercent) !== null && _d !== void 0 ? _d : null, t.id);
                    backfilled++;
                }
            })();
